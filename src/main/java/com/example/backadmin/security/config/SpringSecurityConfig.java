...
import com.example.backadmin.security.filter.JwtAuthenticationFilter;
import com.example.backadmin.security.filter.JwtAutorisationFilter;
...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .antMatchers("/v1/api/authentification/", "/swagger-resources/**",
                        "/swagger-ui.html",
                        "/webjars/**",
    ...
    public void configure(WebSecurity web) throws Exception {
        web.ignoring().antMatchers("/centre-project/v1/**");
